...
public class FragmentOrderCustomer extends Fragment {
    ...
    FrameLayout aLayout;
    private FragmentOrderCustomer context;
    ...
    public static FragmentOrderCustomer createInstance(int itemsCount) {
        FragmentOrderCustomer partThreeFragment = new FragmentOrderCustomer();
    ...
    private int count = 0;
    RecyclerAdapterOrderCustomer recyclerAdapter;
    ...
    private void setupRecyclerView(final View aView, final RecyclerView recyclerView) {
        ...
        recyclerAdapter = new RecyclerAdapterOrderCustomer(this, new ArrayList<Order>());
            ...
            public void run() {
                ...
                try {
                  ...
                  LoginModel aLoginHolder=  LoginHolder.getInstance().getLogin();
                    ...
                    if (NetworkUtil.getConnectivityStatusString(context.getActivity()) != null)
                        aSoapObject = aConnectionPool.ConnectGetHistoryOrders(aLoginHolder.uid);
