...
public class RecyclerItemViewHolderOrderNew extends RecyclerView.ViewHolder {
    ...
    public RecyclerItemViewHolderOrderNew(final View parent, final RecyclerAdapterOrderNew aRecyclerAdapterKala, TextView itemTextViewName, TextView mItemTextViewPrice,
    ...
    public static RecyclerItemViewHolderOrderNew newInstance(RecyclerAdapterOrderNew aRecyclerAdapterKala, View parent) {
        ...
        return new RecyclerItemViewHolderOrderNew(parent, aRecyclerAdapterKala, itemTextViewName, mItemTextViewPrice,
