...
public class RecyclerAdapterSearch extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerAdapterSearch(final FragmentSearch fragmentActivity, List<Kala> itemList) {
        mItemList = itemList;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (fragmentActivity.isList) {
            ...
            return RecyclerItemViewHolderSearch.newInstance(this, view);
        } else {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        final RecyclerItemViewHolderSearch holder = (RecyclerItemViewHolderSearch) viewHolder;
    ...
    public void onTapzBasket(int adapterPosition) {
        ...
        if (LoginHolder.getInstance().getLogin()==null ||
            ...
            if (aKala.categoryId!=Values.takCatId) {
                ManagerCall();
                return;
            }
        }
