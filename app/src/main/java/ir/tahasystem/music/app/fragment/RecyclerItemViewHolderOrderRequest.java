...
public class RecyclerItemViewHolderOrderRequest extends RecyclerView.ViewHolder {
    ...
    public RecyclerItemViewHolderOrderRequest(final View parent, final RecyclerAdapterOrderRequest aRecyclerAdapterKala, TextView itemTextViewName, TextView mItemTextViewPrice,
    ...
    public static RecyclerItemViewHolderOrderRequest newInstance(RecyclerAdapterOrderRequest aRecyclerAdapterKala, View parent) {
        ...
        return new RecyclerItemViewHolderOrderRequest(parent, aRecyclerAdapterKala, itemTextViewName, mItemTextViewPrice,
