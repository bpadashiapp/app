...
public class RecyclerItemViewHolderMsg2H extends RecyclerView.ViewHolder {
    ...
    public RecyclerItemViewHolderMsg2H(final View parent, final RecyclerAdapterMsg2H aRecyclerAdapterKala, TextView itemTextViewName, TextView mItemTextViewDes
    ...
    public static RecyclerItemViewHolderMsg2H newInstance(RecyclerAdapterMsg2H aRecyclerAdapterKala, View parent) {
        ...
        return new RecyclerItemViewHolderMsg2H(parent, aRecyclerAdapterKala, itemTextViewName,
