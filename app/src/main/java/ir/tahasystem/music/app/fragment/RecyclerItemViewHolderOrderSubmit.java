...
public class RecyclerItemViewHolderOrderSubmit extends RecyclerView.ViewHolder {
    ...
    public RecyclerItemViewHolderOrderSubmit(final View parent, final RecyclerAdapterOrderSubmit aRecyclerAdapterKala, TextView itemTextViewName, TextView mItemTextViewPrice,
    ...
    public static RecyclerItemViewHolderOrderSubmit newInstance(RecyclerAdapterOrderSubmit aRecyclerAdapterKala, View parent) {
        ...
        return new RecyclerItemViewHolderOrderSubmit(parent, aRecyclerAdapterKala, itemTextViewName, mItemTextViewPrice,
