...
public class RecyclerItemViewHolderChange extends RecyclerView.ViewHolder {
    ...
    public RecyclerItemViewHolderChange(final View parent, final RecyclerAdapterChange aRecyclerAdapterKala, TextView itemTextViewName,
    ...
    public static RecyclerItemViewHolderChange newInstance(RecyclerAdapterChange aRecyclerAdapterKala, View parent) {
        ...
        return new RecyclerItemViewHolderChange(parent, aRecyclerAdapterKala, itemTextViewName, mItemTextViewPrice,
