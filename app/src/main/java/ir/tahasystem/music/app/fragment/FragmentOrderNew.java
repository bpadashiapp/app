...
public class FragmentOrderNew extends Fragment {

    public final static String ITEMS_COUNT_KEY = "PartThreeFragment$ItemsCount";
    FrameLayout aLayout;
    private FragmentOrderNew context;
    ...
    public static FragmentOrderNew createInstance(int itemsCount) {
        FragmentOrderNew partThreeFragment = new FragmentOrderNew();
   ...
   /* private OnCompleteListener mListener;
    ...
    private int count = 0;
    RecyclerAdapterOrderNew recyclerAdapter;
    ...
    private void setupRecyclerView(final View aView, final RecyclerView recyclerView) {
        ...
        recyclerAdapter = new RecyclerAdapterOrderNew(this, new ArrayList<Order>());
            ...
            public void run() {
                ...
                try {
                  ...
                  LoginModel aLoginHolder=  LoginHolder.getInstance().getLogin();
                    ...
                    if (NetworkUtil.getConnectivityStatusString(context.getActivity()) != null)
                        aSoapObject = aConnectionPool.ConnectReciveOrders(aLoginHolder.user,aLoginHolder.pass,1);
