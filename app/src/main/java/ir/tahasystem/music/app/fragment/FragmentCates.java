...
public class FragmentCates extends Fragment {

    public final static String ITEMS_COUNT_KEY = "PartThreeFragment$ItemsCount";
    public static boolean isChange2;
    FrameLayout aLayout;
    public static FragmentCates context;
    ...
    public static FragmentCates createInstance(int itemsCount) {
        FragmentCates partThreeFragment = new FragmentCates();
...
*/
    ...
    private int count = 0;
    RecyclerAdapterCates recyclerAdapter;
    ...
    private void setupRecyclerView(final View aView, final RecyclerView recyclerView) {
        ...
        recyclerAdapter = new RecyclerAdapterCates(this, new ArrayList<Kala>());
        ...
        ConnectionThreadPool.getInstance().AddTask(new Runnable() {
            ...
            public void run() {
                ...
                List<Kala> cListKala = (List<Kala>) new Serialize().readFromFile(context.getActivity(),
                        "aListKalaCatesHH" + Values.companyId);
