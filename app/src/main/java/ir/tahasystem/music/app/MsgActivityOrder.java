...
public class MsgActivityOrder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentMsg = FragmentMsgOrder.createInstance(11);
    ...
    private void initToolbar() {
        ...
        count.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                ModelHolderService.getInstance().setKalaListChatManager(context, new ArrayList<Kala>());
        ...
        atxt.setText(getString(R.string.manager_part));
