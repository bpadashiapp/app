...
public class RecyclerItemViewHolderSearch extends RecyclerView.ViewHolder {
    ...
    public RecyclerItemViewHolderSearch(final View parent, final RecyclerAdapterSearch aRecyclerAdapterKala, TextView itemTextViewName, TextView mItemTextViewPrice,
    ...
    public static RecyclerItemViewHolderSearch newInstance(RecyclerAdapterSearch aRecyclerAdapterKala, View parent) {
        ...
        return new RecyclerItemViewHolderSearch(parent, aRecyclerAdapterKala, itemTextViewName, mItemTextViewPrice,
