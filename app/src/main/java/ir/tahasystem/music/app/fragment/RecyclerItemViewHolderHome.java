...
public class RecyclerItemViewHolderHome extends RecyclerView.ViewHolder {
    ...
    public RecyclerItemViewHolderHome(final View parent, final RecyclerAdapterHome aRecyclerAdapterKala, TextView itemTextViewName, TextView mItemTextViewPrice,
    ...
    public static RecyclerItemViewHolderHome newInstance(RecyclerAdapterHome aRecyclerAdapterKala, View parent) {
        ...
        return new RecyclerItemViewHolderHome(parent, aRecyclerAdapterKala, itemTextViewName, mItemTextViewPrice,
