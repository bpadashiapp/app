...
* */
public class RecyclerAdapterChangeFilter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private FragmentChangeFilter fragmentActivity;

    public RecyclerAdapterChangeFilter(final FragmentChangeFilter fragmentActivity, List<Kala> itemList) {
        mItemList = itemList;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return RecyclerItemViewHolderChangeFilter.newInstance(this, view);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        final RecyclerItemViewHolderChangeFilter holder = (RecyclerItemViewHolderChangeFilter) viewHolder;
