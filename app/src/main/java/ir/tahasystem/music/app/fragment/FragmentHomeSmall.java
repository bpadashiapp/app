...
public class FragmentHomeSmall extends Fragment {

    public final static String ITEMS_COUNT_KEY = "PartThreeFragment$ItemsCount";
    FrameLayout aLayout;
    private FragmentHomeSmall context;
    ...
    public static FragmentHomeSmall createInstance(int itemsCount) {
        FragmentHomeSmall partThreeFragment = new FragmentHomeSmall();
   ...
   /* private OnCompleteListener mListener;
    ...
    private int count = 0;
    RecyclerAdapterHomeSmall recyclerAdapter;
    ...
    private void setupRecyclerView(final View aView, final RecyclerView recyclerView) {
        ...
        recyclerAdapter = new RecyclerAdapterHomeSmall(this, new ArrayList<Kala>());
        ...
        ConnectionThreadPool.getInstance().AddTask(new Runnable() {
            ...
            public void run() {
                ...
                //List<Kala> cListKala = (List<Kala>) new Serialize().readFromFile(context.getActivity(),
                       // "aListKalaHomeProductsSmall" + Values.companyId + page);
                ...
                try {
                    ...
                    if (NetworkUtil.getConnectivityStatusString(MainActivity.context) != null)
                        aSoapObject = aConnectionPool.ConnectGetProductHomeSmall(Values.companyId,
                                page,limit);
