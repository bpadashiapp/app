...
public class RecyclerItemViewHolderMsgOrder extends RecyclerView.ViewHolder {
    ...
    public RecyclerItemViewHolderMsgOrder(final View parent, final RecyclerAdapterMsgOrder aRecyclerAdapterKala, TextView itemTextViewName, TextView mItemTextViewPrice,
    ...
    public static RecyclerItemViewHolderMsgOrder newInstance(RecyclerAdapterMsgOrder aRecyclerAdapterKala, View parent) {
        ...
        return new RecyclerItemViewHolderMsgOrder(parent, aRecyclerAdapterKala, itemTextViewName, mItemTextViewPrice,
