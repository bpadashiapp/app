...
public class DetialsOrdersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) this.findViewById(R.id.payment_type)).setText(aOrder.getPaymentType(context,aOrder));
        ...
        this.findViewById(R.id.buy_details).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DetialsOrdersActivity.this, DetialsSubOrdersActivity.class));
            }
        });
