...
public class DetialsSubOrdersActivity extends AppCompatActivity {

    Toolbar mToolbar;

    public static DetialsSubOrdersActivity context;
    ...
    private void ChangeFragment() {
        ...
        FragmentOrder fragmentOrder=FragmentOrder.createInstance(45);
        android.support.v4.app.FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
        ft.add(R.id.fragment, fragmentOrder).commit();
    }
    ...
    private void initToolbar() {
        ...
        atxt.setText(getString(R.string.buy_list));
