 ...
 */
public class FragmentHomeCates extends Fragment {

    public final static String ITEMS_COUNT_KEY = "PartThreeFragment$ItemsCount";
    public static final String TAG = FragmentHomeCates.class.getCanonicalName();


    public static FragmentHomeCates context;

    public static CustomViewPager viewPager;

    public static FragmentHomeCates createInstance(int itemsCount) {

        FragmentHomeCates f = new FragmentHomeCates();
    ...
    public FragmentProduct fragmentProduct;

    private void initViewPagerAndTabs() {


        fragmentSubCates = FragmentSubCates.createInstance(35);
        fragmentProduct = FragmentProduct.createInstance(36);
        ...
        viewPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                switch (position) {
                    case 0:
                        if (CatesActivity.context != null)
                            CatesActivity.subTitle.setText(getString(R.string.subcates));
                        break;
                    case 1:
                        if (CatesActivity.context != null)
                                CatesActivity.subTitle.setText(getString(R.string.products));
