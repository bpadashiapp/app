...
public class FragmentProduct extends Fragment {
    ...
    FrameLayout aLayout;
    public static FragmentProduct context;
    ...
    public static FragmentProduct createInstance(int itemsCount) {
        FragmentProduct partThreeFragment = new FragmentProduct();
   ...
   /* private OnCompleteListener mListener;
    ...
    private void setupRecyclerView(final View aView, final RecyclerView recyclerView) {
        ...
        recyclerAdapter = new RecyclerAdapterProduct(this, new ArrayList<Kala>());
        ...
        ConnectionThreadPool.getInstance().AddTask(new Runnable() {
            ...
            public void run() {
               ...
               // List<Kala> cListKala = (List<Kala>) new Serialize().readFromFile(context.getActivity(),
                       // "aListKalaCatProducts"+cateId+ Values.companyId + page);
