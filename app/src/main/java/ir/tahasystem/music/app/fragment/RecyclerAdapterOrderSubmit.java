...
public class RecyclerAdapterOrderSubmit extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerAdapterOrderSubmit(final FragmentOrderSubmit fragmentActivity, List<Order> itemList) {
        mItemList = itemList;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return RecyclerItemViewHolderOrderSubmit.newInstance(this, view);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        RecyclerItemViewHolderOrderSubmit holder = (RecyclerItemViewHolderOrderSubmit) viewHolder;
