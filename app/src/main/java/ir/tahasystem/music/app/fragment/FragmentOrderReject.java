...
public class FragmentOrderReject extends Fragment {
    ...
    FrameLayout aLayout;
    private FragmentOrderReject context;
    ...
    public static FragmentOrderReject createInstance(int itemsCount) {
        FragmentOrderReject partThreeFragment = new FragmentOrderReject();
   ...
   /* private OnCompleteListener mListener;
    ...
    private int count = 0;
    RecyclerAdapterOrderReject recyclerAdapter;
    ...
    private void setupRecyclerView(final View aView, final RecyclerView recyclerView) {
        ...
        recyclerAdapter = new RecyclerAdapterOrderReject(this, new ArrayList<Order>());
            ...
            public void run() {
                ...
                try {
                  ...
                  LoginModel aLoginHolder=  LoginHolder.getInstance().getLogin();
                    ...
                    if (NetworkUtil.getConnectivityStatusString(context.getActivity()) != null)
                        aSoapObject = aConnectionPool.ConnectReciveOrders(aLoginHolder.user,aLoginHolder.pass,7);
