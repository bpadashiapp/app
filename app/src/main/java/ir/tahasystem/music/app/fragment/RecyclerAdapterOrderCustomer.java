...
* */
public class RecyclerAdapterOrderCustomer extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private FragmentOrderCustomer fragmentActivity;

    public RecyclerAdapterOrderCustomer(final FragmentOrderCustomer fragmentActivity, List<Order> itemList) {
        mItemList = itemList;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return RecyclerItemViewHolderOrderCustomer.newInstance(this, view);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        RecyclerItemViewHolderOrderCustomer holder = (RecyclerItemViewHolderOrderCustomer) viewHolder;
