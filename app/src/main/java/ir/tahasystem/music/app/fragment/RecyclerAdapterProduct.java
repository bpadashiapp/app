...
public class RecyclerAdapterProduct extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerAdapterProduct(final FragmentProduct fragmentActivity, List<Kala> itemList) {
        mItemList = itemList;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (fragmentActivity.isList) {
            ...
            return RecyclerItemViewHolderProduct.newInstance(this, view);
        } else {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        final RecyclerItemViewHolderProduct holder = (RecyclerItemViewHolderProduct) viewHolder;
        ...
        //if(!Values.hasDescription){
            // holder.mItemTextViewDes.setVisibility(View.GONE);
       // }else{
            holder.mItemTextViewDes.setVisibility(View.VISIBLE);
        ...
        System.out.println("--->"+aKala.getDescriptionKala());
...
if(Values.appId==3)
        ((TextView)holder.aButton.findViewById(R.id.fab_add_basket_text)).setText(R.string.add_basket_service);
    ...
    public void onTapzBasket(int adapterPosition) {
        ...
        if (CatesActivity.context.aTextViewBasket != null)
            if (ModelHolder.getInstance().getBasketCount() > 0) {
                CatesActivity.context. aTextViewBasket.setVisibility(View.VISIBLE);
                ...
                CatesActivity.context. aTextViewBasket.setVisibility(View.INVISIBLE);
            }
