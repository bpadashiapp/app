...
public class FragmentGallery extends Fragment {
    ...
    public static FragmentGallery createInstance(int itemsCount) {
        FragmentGallery partThreeFragment = new FragmentGallery();
   ...
   /* private OnCompleteListener mListener;
    ...
    private void setupRecyclerView(final View aView, final RecyclerView recyclerView) {
        ...
        recyclerAdapter = new RecyclerAdapterGallery(this, new ArrayList<Company>());
        ...
        ConnectionThreadPool.getInstance().AddTask(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    if (NetworkUtil.getConnectivityStatusString(MainActivity.context) != null)
                        aSoapObject = aConnectionPool.ConnectGetPicsOfCompany(Values.companyId);
                    ...
                    List<Company> bListKala = new Gson().fromJson(aSoapObject.toString(), listType);
                    ...
                    if (bListKala.size() != 0) {
                        ...
                        new Serialize().saveToFile(context.getActivity(), bListKala,
                                "aListKalaGal" + Values.companyId + page);
    ...
    public void setupView(final List<Company> aList, final int length) {
    ...
    public void load() {
        ...
        for(int i=0;i<20;i++){
            Kala aKala=new Kala();
            aKala.name="fff";
            aKala.image="http://www.onlinepakhsh.com/Pictures/Products/_thumbs/coekupno.jpg";
            aList.add(aKala);
        }

        setupView(aList,aList.size());*/
