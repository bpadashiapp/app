...
public class FragmentHome extends Fragment {
    ...
    public static FragmentHome createInstance(int itemsCount) {
        FragmentHome partThreeFragment = new FragmentHome();
   ...
   /* private OnCompleteListener mListener;
    ...
    private int count = 0;
    RecyclerAdapterHome recyclerAdapter;
    ...
    private void setupRecyclerView(final View aView, final RecyclerView recyclerView) {
        ...
        recyclerAdapter = new RecyclerAdapterHome(this, new ArrayList<Kala>());
        ...
        ConnectionThreadPool.getInstance().AddTask(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    if (NetworkUtil.getConnectivityStatusString(MainActivity.context) != null)
                        aSoapObject = aConnectionPool.ConnectGetProductHome(Values.companyId,
                                page,limit);
