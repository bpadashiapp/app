...
public class AlarmSocket extends BroadcastReceiver {
    @Override
    public void onReceive(Context context, Intent intent) {

        System.out.println("ALARAM SOCKET->FIREED!!!");

        if(ServicesSocket.mWebSocketClient==null || ServicesSocket.mWebSocketClient.isClosed()) {
    ...
    public void SetAlarm(Context context, int interval) {
        ...
        Intent i = new Intent(context, AlarmSocket.class);
    ...
    public void CancelAlarm(Context context) {
        ...
        Intent intent = new Intent(context, AlarmSocket.class);
