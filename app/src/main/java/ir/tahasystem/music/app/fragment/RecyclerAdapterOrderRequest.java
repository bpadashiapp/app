...
* */
public class RecyclerAdapterOrderRequest extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private FragmentOrderRequest fragmentActivity;

    public RecyclerAdapterOrderRequest(final FragmentOrderRequest fragmentActivity, List<Order> itemList) {
        mItemList = itemList;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return RecyclerItemViewHolderOrderRequest.newInstance(this, view);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        RecyclerItemViewHolderOrderRequest holder = (RecyclerItemViewHolderOrderRequest) viewHolder;
