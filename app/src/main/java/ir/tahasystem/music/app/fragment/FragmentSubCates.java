...
public class FragmentSubCates extends Fragment {

    public final static String ITEMS_COUNT_KEY = "PartThreeFragment$ItemsCount";
    FrameLayout aLayout;
    private FragmentSubCates context;
    ...
    public static FragmentSubCates createInstance(int itemsCount) {
        FragmentSubCates partThreeFragment = new FragmentSubCates();
   ...
   /* private OnCompleteListener mListener;
    ...
    private int count = 0;
    RecyclerAdapterSubCates recyclerAdapter;
    ...
    private void setupRecyclerView(final View aView, final RecyclerView recyclerView) {
        ...
        recyclerAdapter = new RecyclerAdapterSubCates(this, new ArrayList<Kala>());
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (dy > 0) // check for scroll down
                {
                    ...
                    /*if (loading) {
                        if ((visibleItemCount + pastVisiblesItems) >= totalItemCount && totalItemCount >= 10) {
    ...
    private void getData(final int page, final int limit) {
        ...
        ConnectionThreadPool.getInstance().AddTask(new Runnable() {
            ...
            public void run() {
                ...
                List<Kala> cListKala = (List<Kala>) new Serialize().readFromFile(context.getActivity(),
                        "aListKalaSubCates" + Values.companyId+ cateId);
                ...
                try {
                    ...
                    if (NetworkUtil.getConnectivityStatusString(MainActivity.context) != null)
                        aSoapObject = aConnectionPool.ConnectGetSubCates(Values.companyId,
                                cateId);
                    ...
                    for (int i = 0; i < aSoapObject.getPropertyCount(); i++) {
                        ...
                        aKala.description = (String) cSoapObject.getProperty("description").toString();
