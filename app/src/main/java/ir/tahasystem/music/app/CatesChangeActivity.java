...
public class CatesChangeActivity extends AppCompatActivity {

    Toolbar mToolbar;

    public static CatesChangeActivity context;
    FragmentHomeCatesChange fragmentHomeCates;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentHomeCates =FragmentHomeCatesChange.createInstance(11);
        ...
        count.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                //if(LoginHolder.getInstance().getLogin()==null || !LoginHolder.getInstance().getLogin().hasAccess()){
                  //  ManagerCall();
               // }else {
                    startActivityForResult(new Intent(CatesChangeActivity.this, BasketActivity.class), 1);
               // }
    ...
    public void onBackPressed(){
        ...
        if(FragmentHomeCatesChange.context!=null && FragmentHomeCatesChange.context.viewPager.getCurrentItem()>0)
            FragmentHomeCatesChange.context.viewPager.setCurrentItem(FragmentHomeCatesChange.context.viewPager.getCurrentItem()-1);
        else
            super.onBackPressed();
    }
