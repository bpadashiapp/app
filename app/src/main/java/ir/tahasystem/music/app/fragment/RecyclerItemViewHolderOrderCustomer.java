...
public class RecyclerItemViewHolderOrderCustomer extends RecyclerView.ViewHolder {
    ...
    public RecyclerItemViewHolderOrderCustomer(final View parent, final RecyclerAdapterOrderCustomer aRecyclerAdapterKala, TextView itemTextViewName, TextView mItemTextViewPrice,
    ...
    public static RecyclerItemViewHolderOrderCustomer newInstance(RecyclerAdapterOrderCustomer aRecyclerAdapterKala, View parent) {
        ...
        return new RecyclerItemViewHolderOrderCustomer(parent, aRecyclerAdapterKala, itemTextViewName, mItemTextViewPrice,
