...
public class FragmentChangeFilter extends Fragment {

    public final static String ITEMS_COUNT_KEY = "PartThreeFragment$ItemsCount";

    FrameLayout aLayout;
    public static FragmentChangeFilter context;
    ...
    public static FragmentChangeFilter createInstance(int itemsCount) {
        FragmentChangeFilter partThreeFragment = new FragmentChangeFilter();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View aView = (View) inflater.inflate(R.layout.fragment_kala_change_filter, container, false);
        ...
        showBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(recyclerAdapter!=null)  recyclerAdapter.clearItem();  getData(0, 10);
   ...
   /* private OnCompleteListener mListener;
    ...
    public int count = 0;
    public RecyclerAdapterChangeFilter recyclerAdapter;
    ...
    private void setupRecyclerView(final View aView, final RecyclerView recyclerView) {
        ...
        recyclerAdapter = new RecyclerAdapterChangeFilter(this, new ArrayList<Kala>());
        ...
        ConnectionThreadPool.getInstance().AddTask(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    if (NetworkUtil.getConnectivityStatusString(context.getActivity()) != null)
                        aSoapObject = aConnectionPool.ConnectGetProductSearchFilter(Values.companyId, "",
                                page, limit);
