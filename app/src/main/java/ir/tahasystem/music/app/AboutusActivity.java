...
public class AboutusActivity extends AppCompatActivity {
    ...
    public static AboutusActivity context;
    ...
    private void initToolbar() {
        ...
        atxt.setText(getString(R.string.aboutus));
    ...
    public void setupView(final Company company) {
        ...
        ((Activity) context).runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                ((TextView)findViewById(R.id.name)).setText(Html.fromHtml(company.companyName));
                ((TextView)findViewById(R.id.description)).setText(Html.fromHtml(company.messageDay+"\n"+company.shortDescription+"\n"+company.fullDescription));
