...
import ir.tahasystem.music.app.DetialsOrdersActivityReject;
...
* */
public class RecyclerAdapterOrderReject extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private FragmentOrderReject fragmentActivity;

    public RecyclerAdapterOrderReject(final FragmentOrderReject fragmentActivity, List<Order> itemList) {
        mItemList = itemList;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return RecyclerItemViewHolderOrderReject.newInstance(this, view);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        RecyclerItemViewHolderOrderReject holder = (RecyclerItemViewHolderOrderReject) viewHolder;
    ...
    public void onTapz(final int pos) {
        ...
        DetialsOrdersActivityReject.isNew=false;
        DetialsOrdersActivityReject.aOrder=mItemList.get(pos);
        fragmentActivity.startActivity(new Intent(fragmentActivity.getActivity(), DetialsOrdersActivityReject.class));
