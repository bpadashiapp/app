...
public class FragmentMsgOrder extends Fragment {
    ...
    public static FragmentMsgOrder createInstance(int itemsCount) {
        FragmentMsgOrder partThreeFragment = new FragmentMsgOrder();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        aView.findViewById(R.id.btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (msg.trim().length() != 0) {
                    ...
                    hideKeyboardFrom(FragmentMsgOrder.this.getActivity(), editText);
                    ...
                    aModel.receiver = RecyclerAdapterMsg2HOrder.reciever;
                    SimpleDateFormat df = new SimpleDateFormat("MMMM dd hh:mm");
                    aModel.date = df.format(new Date());
                    aModel.text = msg;
                    aModel.command = "get";
                    aModel.isRec = 0;
                    aModel.name = getString(R.string.manager_part)+" "+ LoginHolder.getInstance().getLogin().uid;
                    aModel.isServer=2;
                    ...
                    if (ServicesSocketManager.mWebSocketClient != null && ServicesSocketManager.mWebSocketClient.isOpen()) {
                        ServicesSocketManager.mWebSocketClient.send(new Gson().toJson(aModel).toString());
                        System.out.println(new Gson().toJson(aModel).toString());
                        msg(getString(R.string.msg_sended));
                        editText.setText("");

                        ModelHolderService.getInstance().setKalaListChatManager(context.getActivity(), aModel);
        ...
        refreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
              ...
              Kala aModel = new Kala();
                aModel.uid = UUID.randomUUID().toString();
                aModel.sender = String.valueOf(Values.companyId);
                aModel.receiver ="";
                aModel.date = "";
                aModel.text = "";
                aModel.command = "list";
                ...
                aModel.companyId= Values.companyId;
                  ...
                  ServicesSocketManager. mWebSocketClient.send(new Gson().toJson(aModel));
   ...
   /* private OnCompleteListener mListener;
    ...
    private void setupRecyclerView(final View aView, final RecyclerView recyclerView) {
        ...
        recyclerAdapter = new RecyclerAdapterMsgOrder(this, new ArrayList<Kala>());
    ...
    private void setupRecyclerViewH(final View aView, final RecyclerView recyclerView) {
        ...
        recyclerAdapterH = new RecyclerAdapterMsg2HOrder(this, new ArrayList<Kala>());
        ...
        ConnectionThreadPool.getInstance().AddTask(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    List<Kala> oldKalaList = ModelHolderService.getInstance().getKalaListChatManager(context.getActivity());
                    ...
                    ModelHolderService.getInstance().setKalaListChatManager(context.getActivity(), aListKala);
        ...
        context.getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                for (Kala fKala : recyclerAdapterH.mItemList) {
                    ...
                    if (  fKala.sender.equals(aKala.sender) ||  fKala.numServer != aKala.numServer || aKala.isServer != 1) {
                        toAdd = false;
                    }

                }
                if (aKala.isServer == 1 && toAdd) {
