...
public class AboutCreatorActivity extends AppCompatActivity {
    ...
    public static AboutCreatorActivity context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contactus_creator);
        initToolbar();
    ...
    private void initToolbar() {
        ...
        atxt.setText(getString(R.string.about_creator));
        ...
        ConnectionThreadPool.getInstance().AddTask(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    if (NetworkUtil.getConnectivityStatusString(MainActivity.context) != null)
                        aSoapObject = aConnectionPool.ConnectGetAboutUs();
    ...
    public void setupView(final Company company) {
        ...
        ((Activity) context).runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                ((TextView)findViewById(R.id.description)).setText(Html.fromHtml(company.messageDay+"<br><br><br>"+company.shortDescription+"<br>"+company.fullDescription));
                ((TextView)findViewById(R.id.address)).setText(company.address);

                TextView aTextView= (TextView)findViewById(R.id.description);
                aTextView.setMovementMethod(LinkMovementMethod.getInstance());
                aTextView.setLinkTextColor(Color.BLUE);
